...
If you set this to the path of a file on your system, for instance consider a template file at `git config --global commit.template C:\CC_Applications/git-commit-template.txt` 
